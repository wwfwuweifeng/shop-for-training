...
public class SFTOrderOperateLog {
    ...
    public SFTOrderOperateLog(Long id, String orderId, String goodsId, String goodsName, String goodsCoverImage, String tag, Integer buyPrice, Integer buyNum, Integer totalMoney, Date createTime) {
        this.id = id;
